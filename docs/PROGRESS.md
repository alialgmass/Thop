...
| 3.3 | Catalog — Bulk Import + Limits | ⬜ | issue **#16** (blocked by #15). XLSX/CSV queued import (row-level partial failure)، `product_limit` عبر الـ batch، review queue، per-row report. ملاحظة: مكتبة spreadsheet محتاجة موافقة. |
