...
| 3.2 | Catalog — Media | ⬜ | issue **#15**. `product_media` على disk `public`، MIME/size validation، ≥1 صورة قبل publish، two-phase save (AVL-NFR-03). |
